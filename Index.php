...
<head>
    ...
    <title>Adii.exe BOTS Telegram Php Bot Host</title>
...
<body>
    <div class="main-container">
        <div class="card">
            ...
            <div class="header">
                <h1>Adii.exe BOTS Telegram PHP Bot Host</h1>
        ...
        <div class="footer">
            <p>Created with <i class="fas fa-heart" style="color: #ff375f;"></i> by Adii.exe BOTS</p>
        </div>
    </div>
